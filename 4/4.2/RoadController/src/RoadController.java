...
public class RoadController {
    ...
    public static int maxOncomingSpeed = 59; // km/h
    //    int speedFineGrade
...
//            Car car
             ...
             */
//            boolean policeCalled --не используемая переменная
            boolean policeCalled = false;
            //String criminalNumber -- переменная для прохода по всем элементам возвращаемых из Класса Police
